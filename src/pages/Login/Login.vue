<template>
  <section class="loginContainer">
    <div class="loginInner">
      ...
      <div class="login_content">
        <form @submit.prevent="login">
          <div :class="{ on: loginWay }">
            ...
            <section class="login_verification"><input type="tel" maxlength="8" placeholder="验证码" v-model="captcha" /></section>
          ...
          <div :class="{ on: !loginWay }">
            <section>
              <section class="login_message"><input type="tel" maxlength="11" placeholder="手机/邮箱/用户名" v-model="name" /></section>
      ...
      <a class="go_back" @click="$router.back()"><i class="iconfont icon-jiantou2"></i></a>
    </div>
  ...
  methods: {
    ...
    login() {
      if (this.loginWay) {
        ...
        if (!this.name) {
          this.showAlert('姓名不可为空')
        } else if (!this.pwd) {
          this.showAlert('密码不可为空')
        } else if (!this.captcha) {
          this.showAlert('验证码不可为空')
        }
      }
    },
    closeTip() {
